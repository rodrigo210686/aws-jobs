...
aws s3 cp gclogs-$NOW.tar.gz "s3://hybrisapplog/${env}/gclogs2/${instance_name}/${instance_name}_${instance_id}_${NOW}.tar.gz" --expires $expirationDate --acl bucket-owner-full-control
rm -rf  gclogs-$NOW*
